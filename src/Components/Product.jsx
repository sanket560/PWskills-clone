  ...
  return (
    <div className='h-auto w-100 flex flex-wrap flex-col'>
        ...
        <div className='h-auto w-100 flex flex-wrap justify-evenly mt-6'>
            <div className='w-[250px] h-auto flex flex-col items-center m-4 p-3 hover:border'>
               <img className='md:w-36' src={img1} alt="" />
               <h2 className='text-2xl font-bold text-indigo-200 text-center'>PW Skills Lab</h2>
               <p className='text-l text-center text-slate-400 font-bold mt-3'>Supercharge your project development with our robust lab.</p>
            </div>
            <div className='w-[250px] h-auto flex flex-col m-4 p-3 hover:border'>
               <img src={img2} alt="" />
               <h2 className='text-2xl font-bold text-indigo-200 text-center'>Job Portal</h2>
            ...
            <div className='w-[250px] h-auto flex flex-col m-4 p-3 hover:border'>
               <img src={img3} alt="" />
               <h2 className='text-2xl font-bold text-indigo-200 text-center'>Experience portal</h2>
            ...
            <div className='w-[250px] h-auto flex flex-col m-4 p-3 hover:border'>
               <img src={img4} alt="" />
               <h2 className='text-2xl font-bold text-indigo-200 text-center'>Become an affiliate</h2>
            ...
            <div className='w-[250px] h-auto items-center flex flex-col m-4 p-3 hover:border'>
               <img className='md:w-36' src={img5} alt="" />
               <h2 className='text-2xl font-bold text-indigo-200 text-center'>Hall of fame</h2>
